...
export const STAGES: StageMeta[] = [
  ...
  },
  {
    ...
    keyVariables: [
      { name: "trigger", desc: "人のPC起動時『翌日分を予約して』(manual)" },
      { name: "peak slots", desc: "朝6-8 / 昼12 / 夕15-17 に割当" },
    ],
    logicKind: "io",
    sourcePaths: [".claude/skills/x-scheduled-publish/SKILL.md", "apps/x-account-system/src/jobs/line-event.ts"],
