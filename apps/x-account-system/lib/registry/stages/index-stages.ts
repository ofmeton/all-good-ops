...
export const STAGES: StageMeta[] = [
  ...
  },
  {
    ...
    upstream: ["compose"], downstream: ["line-approval"],
  },
  {
    ...
    sourcePaths: ["apps/x-account-system/lib/writer/", "apps/x-account-system/src/jobs/line-event.ts"],
    upstream: [], downstream: ["editor"],
  },
  {
    ...
    upstream: ["writer"], downstream: ["line-approval"],
  },
  {
    ...
    upstream: ["check", "editor"], downstream: ["scheduled-publish"],
  },
  {
