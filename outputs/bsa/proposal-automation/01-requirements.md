...
> SSOT 参照: `knowledge/context/pricing-catalog.md` / `outputs/bsa/proposal-templates.md` / `outputs/bsa/watcher-design.md`
...
- `knowledge/context/pricing-catalog.md` — 商品ライン L1/L2/L3/L4 の価格・納期 SSOT
...
- 商品ライン SSOT: `knowledge/context/pricing-catalog.md`
