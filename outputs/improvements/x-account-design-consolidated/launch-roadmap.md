...
|---|---|---|---|---|
| **PR-A** | Editor 6+5 pipeline 統合 (DLP redact + 業法 lint + 失敗談月 ≤ 4 上限 + Hook 配分 check + 公開許諾 gate) | `lib/editor/pipeline.ts` + integration tests | 1 セッション | ★★★★★ (P0、blocker for PR-B) |
...
- Week 1 末で **E-46 (Editor 6+5 ルール 1 件処理 < 10 秒)** 実測
