...
| `frontend-design:frontend-design` | DESIGN.md 生成・UI品質判断時 |
| `knowledge/context/motion-techniques-catalog.md` | DESIGN.md にモーション仕様を入れる時 — 「AIっぽくない動き」の標準語彙。技法 1–7 + 補助で構成宣言 |
