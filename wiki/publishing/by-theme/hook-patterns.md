...
## 観測 [2026-05-20] — uravation: 3 ツイート構成のフック設計

出典: [[../inspirations/note-2026-05-20-uravation-claude-x-viral]]
3 ツイート構成では 1 本目（フック）が「数字 + 業務名 / 結論先出し」に集約される。2 本目以降が具体 → CTA と役割が明確なので、フックに全エネルギーを集中できる構造が強い。

## 観測 [2026-05-20] — chaen: 感情揺さぶりと誘導記号
