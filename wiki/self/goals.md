...
| # | 戦略 KGI | ステータス | 備考 |
|---|---|---|---|
| 1 | **BSA戦略（2026-04-22〜08-22）の完走** | 🟡 稼働中 | Week1-16 KPI 達成、認定ランサー / Coconala プラチナ到達。詳細 [[overview]]（BSA） |
| 2 | 月収 26 万円の安定達成 | ⏸ 凍結中 | **BSA 期間中は Week KPI を優先、月収目標は凍結**（CLAUDE.md 整合） |
| 3 | 子どもの居場所の具体化（2026 年以内）＋ 社団法人設立 | 🟡 準備中 | [[overview|ibasho overview]] 参照 |
...
| KPI | 現在値 | 目標 | 状態 |
|---|---|---|---|
| **BSA Week KPI（提案 / 受注 / 納品 / 評価）** | 週次レビュー出力参照 | [[overview]]（BSA）の Week KPI 運用方針 | 🟡 |
...
- BSA Week KPI: `scripts/weekly-review.sh` 出力 + [[overview]]（BSA） / `data/improvement-log.jsonl`
